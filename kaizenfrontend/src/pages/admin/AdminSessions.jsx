...
export default function AdminSessions() {
  ...
  const downloadReceiptAsPDF = async () => {
    ...
    try {
      const receiptNumber = `KZN-${receiptModal.id}-${new Date(receiptModal.sessionDate).getFullYear()}`;
      const doc = new jsPDF();
      ...
      const rows = [
        ...
        ['Transaction Date', new Date(receiptModal.sessionDate).toLocaleString('en-KE')],
        ['Client', receiptModal.clientName],
        ['Professional', receiptModal.professionalName],
        ['Session Date & Time', formatDate(receiptModal.sessionDate)],
