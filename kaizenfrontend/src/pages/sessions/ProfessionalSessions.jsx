...
export default function ProfessionalSessions() {
  ...
  const downloadReceiptAsPDF = async () => {
    ...
    try {
      ...
      const clientName = receiptModal.client ? getClientName(receiptModal.client) : (receiptModal.directClientName || 'N/A');
      const doc = new jsPDF();
      ...
      const rows = [
        ...
        ['Client', clientName],
        ['Client Notes', receiptModal.notes || 'No notes provided'],
