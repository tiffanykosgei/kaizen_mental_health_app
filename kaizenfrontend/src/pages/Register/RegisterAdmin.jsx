...
export default function RegisterAdmin() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      if (data.requiresPassword) {
        ...
        localStorage.setItem('googleRole', 'Admin');
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      ...
      <div style={{ width: '100%', maxWidth: 500, background: 'var(--bg-card)', borderRadius: 20, border: '1.5px solid var(--border)', padding: '40px 36px', boxShadow: 'var(--shadow)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 8 }}>
            Join as an Administrator to manage the platform
          </p>
        </div>
        ...
        {step === 1 && (
          <>
            ...
            <div style={{ textAlign: 'center', marginTop: 24, fontSize: 13, color: 'var(--text-muted)' }}>
              ...
              <Link to="/login/admin" style={{ color: config.color, fontWeight: 500 }}>
                Sign In
              </Link>
            </div>
          </>
